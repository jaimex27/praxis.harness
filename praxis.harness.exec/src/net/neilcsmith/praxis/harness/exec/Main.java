 ...
 * have any questions.
 */
package net.neilcsmith.praxis.harness.exec;
...
class Main {
    ...
    private final static String CODE_NAME_BASE = "net.neilcsmith.praxis.harness.exec";
    private Env env;
    ...
    private List<String> findScripts() {
        ...
        List<String> scripts = new ArrayList<String>(pxps.size());
    ...
    private void initHub(List<String> scripts) throws IllegalRootStateException {
        DefaultHub hub = new DefaultHub(new ScriptServiceImpl(),
                new TaskServiceImpl(), new HarnessPlayer(scripts));
        hub.activate();
    }
